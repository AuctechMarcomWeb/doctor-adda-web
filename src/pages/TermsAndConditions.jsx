                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      Welcome to Doctor Adda. These Terms and Conditions
                      ("Terms") govern your use of our healthcare consultation
                      platform and mobile application ("Service"). By accessing
                      or using our Service, you agree to be bound by these
                      Terms.
                    </p>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      consultations, medical advice, and healthcare services.
                      Our Service includes:
                    </p>
                    <ul className="list-disc pl-6 text-gray-700">
                      <li>
                        Video and audio consultations with licensed doctors
                      </li>
                  ...
                  <section className="mb-8">
                    ...
                    <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
                      ...
                      <ul className="list-disc pl-6 text-red-700">
                        <li>
                          Doctor Adda is NOT for medical emergencies. Call 911
                          or go to the nearest emergency room for emergencies.
                        </li>
                        <li>
                          Our Service does not replace in-person medical care
                          when required.
                        </li>
                        <li>
                        ...
                        <li>
                          Telemedicine has limitations and may not be suitable
                    ...
                    <p className="text-gray-700 mb-4">
                      Medical advice provided through our Service is based on
                      the information you provide. It is your responsibility to
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 text-gray-700">
                      ...
                      <li>
                        Not use the Service for controlled substance
                        prescriptions
                      </li>
                    </ul>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      platform. Prices are clearly displayed before purchase.
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      your personal information is governed by our Privacy
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      are owned by Doctor Adda and are protected by copyright,
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-gray-700">
                      ...
                      will notify users of any changes by posting the new Terms
                      on this page. Changes become effective immediately upon
                      posting.
                    </p>
                  </section>
                </div>
