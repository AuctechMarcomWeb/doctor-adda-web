    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg font-sans text-gray-800 py-42 ">
      <section>
        ...
        <p className="mb-6 text-gray-700 leading-relaxed text-lg">
          At <span className="font-semibold text-green-700">Dr Adda</span>, we
          are committed to delivering your orders promptly and safely. Please
        ...
        <ul className="space-y-6 text-gray-700 text-base">
          ...
          <li>
            ...
            <span className="font-semibold text-green-700">9005278148</span>.
          </li>
