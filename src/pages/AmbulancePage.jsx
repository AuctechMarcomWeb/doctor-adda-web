  ...
  return (
    ...
    background: "linear-gradient(135deg, rgb(0, 123, 189) 0%, rgb(0, 90, 140) 100%)"}}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a href="tel:108" className="inline-block bg-white text-red-600 font-bold py-3 px-8 rounded-full text-lg hover:bg-red-50 transition-all duration-300 transform hover:scale-105">
            📞 Call 108
          </a>
        </div>
      </div>
