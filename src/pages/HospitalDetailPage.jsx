...
const HospitalDetailPage = () => {
  ...
  const facilities = [
    { name: "Emergency Services", icon: <Heart className="w-4 h-4" /> },
    { name: "24/7 Pharmacy", icon: <Clock className="w-4 h-4" /> },
    { name: "ICU & NICU Units", icon: <Shield className="w-4 h-4" /> },
    { name: "Blood Bank", icon: <Hospital className="w-4 h-4" /> },
    { name: "Radiology (X-ray, MRI, CT)", icon: <BadgeCheck className="w-4 h-4" /> },
    { name: "Pathology Lab", icon: <Stethoscope className="w-4 h-4" /> },
  ];
  ...
  const stats = [
    ...
    { label: "Expert Doctors", value: "150+", icon: <Users className="w-6 h-6" /> },
    { label: "Successful Surgeries", value: "50K+", icon: <Heart className="w-6 h-6" /> },
  ...
  return (
    ...
    background: "linear-gradient(135deg, rgb(0, 123, 189) 0%, rgb(0, 90, 140) 100%)" }}></div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 text-gray-600 mb-4">
                  ...
                  <span className="text-lg text-white">Sector 62, Noida, Delhi NCR</span>
                </div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="ml-2 text-white font-semibold">4.8 (2,847 reviews)</span>
                  </div>
                </div>
              </div>

              <p className="text-white text-lg leading-relaxed">
                A premier healthcare destination in Delhi NCR, offering world-class medical care across multiple specialties. 
                Our state-of-the-art facility combines cutting-edge technology with compassionate care to deliver exceptional 
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
            ...
            {activeTab === "about" && (
              <div className="space-y-12">
                ...
                <div className="prose max-w-none">
                  <h2 className="text-3xl font-bold text-gray-800 mb-6">About CityCare Hospital</h2>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    CityCare Multispeciality Hospital stands as a beacon of excellence in healthcare delivery across Delhi NCR. 
                    Our commitment to providing comprehensive, patient-centered care is reflected in our state-of-the-art infrastructure, 
                    advanced medical technology, and team of highly qualified healthcare professionals. We believe in treating not just 
                    the condition, but caring for the whole person with compassion, respect, and dignity.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {facilities.map((facility, idx) => (
                      <div key={idx} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 hover:shadow-md transition-all duration-300">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                    {departments.map((dept, idx) => (
                      <div key={idx} className="bg-white border-2 border-gray-100 hover:border-blue-300 rounded-lg px-4 py-3 text-center transition-all duration-300 hover:shadow-md">
                ...
                {/* Doctors */}
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-6">Our Expert Doctors</h3>
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {doctors.map((doc, idx) => (
                      <div key={idx} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <div className="flex flex-col items-center text-center">
                          ...
                          />
                          <h4 className="text-xl font-bold text-gray-800 mb-1">{doc.name}</h4>
                          <p className="text-blue-600 font-semibold mb-2">{doc.specialty}</p>
                          <p className="text-gray-600 text-sm mb-3">{doc.experience}</p>
                          <div className="flex items-center gap-1">
                            <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                            <span className="text-gray-700 font-semibold">{doc.rating}</span>
                          </div>
                        </div>
                      </div>
                    ))}
            ...
            {activeTab === "review" && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-gray-800 mb-2">What Our Patients Say</h2>
                  <p className="text-lg text-gray-600">Real experiences from our valued patients</p>
                </div>

                {[
                  {
                    name: "Priya Singh",
                    comment: "Exceptional care and professionalism! The doctors took time to explain everything clearly, and the nursing staff was incredibly compassionate. The facilities are world-class and I felt completely at ease throughout my treatment.",
                    rating: 5,
                    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
                  ...
                  {
                    name: "Amit Khurana",
                    comment: "Clean, modern hospital with state-of-the-art equipment. The online booking system made scheduling so convenient, and the staff guided me through every step. Highly recommend for anyone seeking quality healthcare.",
                    rating: 4,
                  ...
                  {
                    name: "Sunita Sharma",
                    comment: "Outstanding experience from admission to discharge. The pediatric team was wonderful with my child, making them feel comfortable and safe. The follow-up care was excellent too.",
                    rating: 5,
                    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3">
                          <div>
                            ...
                            <p className="text-blue-600 font-medium">{review.treatment}</p>
                          </div>
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg italic">"{review.comment}"</p>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="bg-[#00659d] rounded-3xl p-8 text-white text-center shadow-2xl">
          ...
          <p className="text-xl mb-6 opacity-90">Book your appointment today and discover why thousands trust CityCare Hospital</p>
