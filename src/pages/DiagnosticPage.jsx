...
const DiagnosticPage = () => {
  ...
  const filteredData = diagnosticData.filter((diagnostic) => {
    ...
    const matchesFilter =
      filterType === "all" ||
      diagnostic.type.toLowerCase().includes(filterType.toLowerCase());
          ...
          <div className="flex flex-row items-center md:flex-row gap-4">
            ...
            <div className="flex-1 relative ">
              ...
              <input
                ...
                className="w-full pl-10 pr-4  text-sm md:text-base md:py-3 py-1 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300"
                value={searchTerm}
