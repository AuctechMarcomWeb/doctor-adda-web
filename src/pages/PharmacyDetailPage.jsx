...
const PharmacyDetailPage = () => {
  ...
  const handleCartSubmit = (medicines) => {
    console.log("Medicines added to cart:", medicines);
    // send medicines to API/cart
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 md:pt-28">
      ...
      <div className="relative">
        ...
        <div className="relative sm:w-full lg:w-[80%]  xl:w-[80%] 2xl:w-[70%] mx-auto  py-8">
          {/* Header Actions */}
      ...
      {/* Main Content Tabs */}
      <div className="sm:w-full lg:w-[80%]  xl:w-[80%] 2xl:w-[70%] mx-auto  py-12">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Tab Navigation */}
