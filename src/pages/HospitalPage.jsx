          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div className="text-left space-y-6">
              ...
              <div className="pt-6 animate-fadeInUp animation-delay-700">
                <button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-4 px-8 rounded-full text-lg shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3 group">
