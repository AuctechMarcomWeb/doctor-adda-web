...
import { Menu, X, ArrowRight, Star, Users, Clock, Shield, Heart, Stethoscope, Calendar, MessageCircle, Phone, Mail, MapPin } from 'lucide-react';
...
const DoctorAddaLanding = () => {
  ...
  const fadeInUp = (id) => `transform transition-all duration-1000 ${
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="#doctors" className="block px-3 py-2 text-gray-700 hover:text-blue-600">Doctors</a>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Connect with certified doctors, book appointments instantly, and get expert medical advice from the comfort of your home.
              </p>
            ...
            {[
              {
                ...
                description: "Connect with doctors via video call, chat, or phone from anywhere"
              },
              {
              ...
              },
              {
                ...
                description: "Round-the-clock emergency medical support when you need it"
              },
              {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                experience: "10 years",
                rating: "5.0",
                image: "https://images.unsplash.com/photo-1594824475905-537c7ba2d1c4?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
              }
            ].map((doctor, index) => (
              <div 
                key={index}
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Join thousands of patients who trust Doctor Adda for their healthcare needs. 
            Get started today and experience healthcare like never before.
          </p>
      ...
      <footer id="contact" className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Your trusted healthcare partner, providing quality medical services and connecting you with the best doctors.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="#doctors" className="block text-gray-400 hover:text-white transition-colors">Doctors</a>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Doctor Adda. All rights reserved. Made with ❤️ for better healthcare.</p>
          </div>
        </div>
      </footer>
    </div>
