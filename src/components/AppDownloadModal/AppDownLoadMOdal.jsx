  ...
  return (
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4">
        <Dialog.Panel className="relative bg-white rounded-2xl p-8 w-full max-w-4xl shadow-2xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                {/* Phone Frame */}
                <div className="w-64 h-[520px] bg-gray-200 rounded-[2.5rem] p-3 shadow-xl">
            ...
            <div className="flex-1 text-left max-w-md">
              ...
              {/* Main Title */}
              <Dialog.Title className="text-4xl font-bold text-gray-900 mb-4 leading-tight">
              ...
              {/* Call to Action */}
              <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors min-w-[160px]"
                >
