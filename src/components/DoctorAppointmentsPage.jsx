...
const DoctorAppointmentsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="sm:w-full lg:w-[80%] xl:w-[80%] 2xl:w-[70%] mx-auto px-4 py-22 sm:px-6 lg:px-8 sm:py-38">
        {/* Notification */}
        {notification && (
        ...
        <div className="text-center md:mb-8 mb-4 px-2">
          <h2 className="text-xl md:text-2xl  font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-3">
            My Appointments
          </h2>
        ...
        <div className="flex gap-3 sm:gap-4 md:mb-8 mb-4 flex-wrap justify-center">
          {[
            ...
            <button
              ...
              className={`px-5 sm:px-8 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-semibold shadow-md sm:shadow-lg hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 ${
                filter === btn.value
                ...
                <div className="grid grid-cols-1  gap-4 items-center">
                  ...
                  <div className="lg:col-span-3 grid sm:grid-cols-3 grid-cols-2 gap-3">
                    <div className="flex items-center gap-2 p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 text-xs md:text-sm">{appt.date}</p>
                    ...
                    <div className="flex items-center gap-2 p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-green-100">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 text-xs md:text-sm">{appt.time}</p>
                    ...
                    <div className="flex items-center gap-2 p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-purple-100">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 text-xs md:text-sm">{appt.service}</p>
                        <p className="text-gray-500 text-xs md:text-sm">Service</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-2 grid grid-cols-3 gap-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-1 py-2 px-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-all duration-300 text-xs md:text-sm font-semibold border border-blue-200"
                    >
                      <Phone size={12} />
                      Call
                    </button>
                    <button
                      ...
                      className="flex items-center justify-center gap-1 py-2 px-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-all duration-300 text-xs md:text-sm font-semibold border border-green-200"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center py-2 px-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-all duration-300 text-xs md:text-sm font-semibold border border-red-200"
                    >
                      Cancel
                    </button>
                  </div>
