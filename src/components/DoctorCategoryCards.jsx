...
const      DoctorCategoryCards = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-[70%]">
    {/* Header */}
            ...
            <SwiperSlide key={index}>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <button
                    className="w-full bg-[#00669e] text-white font-semibold py-2 sm:py-3 px-4 rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    View More
                  </button>
                </div>
