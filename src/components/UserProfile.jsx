...
import { updateUserProfile } from "../redux/slices/userSlice"; // ✅ you need this action in your redux slice
                  ...
                  <div>
                    ...
                    {editMode ? (
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg border focus:border-blue-500"
                      />
                    ) : (
