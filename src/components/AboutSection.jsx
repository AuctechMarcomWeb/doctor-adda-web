...
import { Heart, Users, Clock, Shield, Stethoscope, Activity } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Main Image Container */}
              <div className="relative bg-gradient-to-br from-blue-600 to-green-600 rounded-3xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                <div className="bg-white rounded-2xl p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Healthcare Made Simple</h3>
                  <p className="text-gray-600 mb-6">Connecting you with trusted medical professionals instantly</p>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Your comprehensive healthcare solution that bridges the gap between doctors and patients. 
              We make medical consultations more accessible, convenient, and efficient through our innovative platform.
            </p>
