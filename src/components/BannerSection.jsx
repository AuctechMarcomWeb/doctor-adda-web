...
const BannerSection = () => {
  ...
  return (
    <div
      className=" mx-auto text-white p-6 md:p-12 rounded-3xl flex flex-col md:flex-row items-center justify-between lg:w-[85%] sm:w-full xl:w-[85%]"
      style={{
        background:
    ...
    >
      ...
      <div className="max-w-7xl  py-20 ">
        ...
        <div className="mt-8 w-full max-w-xl mx-auto text-black">
  <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between w-full">
    ...
    {/* Dropdown */}
    <select
      className="w-full md:w-1/3 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white"
    >
