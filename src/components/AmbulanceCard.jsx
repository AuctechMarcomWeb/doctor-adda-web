...
const AmbulanceCard = ({ id, name, type, capacity, price, location, rating, image }) => {
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div
                className="flex items-center text-white text-xs px-3 py-1 rounded-full font-semibold shadow-sm"
                style={{
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors duration-200">
            <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
              <img
                src="https://i.pinimg.com/1200x/9d/d0/f2/9dd0f2f55fb40d05d3f8a10991dbde22.jpg"
                alt=""
                className="w-5 h-5"
              />
            </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors duration-200">
            <div className="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
              <img
                src="https://i.pinimg.com/736x/1b/18/dc/1b18dcc8c9b6e8c9e8876b28422e6f61.jpg"
                alt=""
                className="w-5 h-5"
              />
            </div>
