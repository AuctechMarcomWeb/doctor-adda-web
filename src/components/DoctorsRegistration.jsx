...
const handleSubmit = async () => {
  ...
  setLoading(true);
  try {
    const payload = { ...formData, clinics };
    console.log("Final payload before submit:", payload);
    const response = await postRequest({
      url: `doctor/register/${userId}`,
      cred: payload,
    });
...
clinics.forEach((clinic, i) => {
  if (!clinic.clinicName) newErrors[`clinicName_${i}`] = "Clinic name is required";
  if (!clinic.consultationFee) newErrors[`consultationFee_${i}`] = "Consultation fee is required";
});

  // Timing Validation (agar service in-clinic ya diagnostic hai to required)
  if (formData.serviceType === "In-clinic" || formData.serviceType === "Video Consultation") {
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleClinicChange(index, "clinicName", e.target.value)
            }
        ...
        <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <input
              ...
              onChange={(e) =>
                handleClinicChange(index, "startTime", e.target.value)
              }
            ...
            <select
              ...
              onChange={(e) =>
                handleClinicChange(index, "duration", e.target.value)
              }
        ...
        <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <input
              ...
              onChange={(e) =>
                handleClinicChange(index, "videoStartTime", e.target.value)
              }
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"
              placeholder="Select Time"
            />
            <input
              ...
              onChange={(e) =>
                handleClinicChange(index, "videoEndTime", e.target.value)
              }
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"
              placeholder="Select Time"
            />
            <select
              ...
              onChange={(e) =>
                handleClinicChange(index, "videoDuration", e.target.value)
              }
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"
            >
              <option value="">Duration Per Patient</option>
        ...
        <div className="grid md:grid-cols-1 gap-4">
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleClinicChange(index, "consultationFee", e.target.value)
              }
        ...
        <div className="grid md:grid-cols-1 gap-4">
          <div className="space-y-2">
            ...
            <input
              type="text"
              placeholder="eg. 77.5946, 12.9716"
value={
  clinic?.location?.coordinates?.length
    ? clinic.location.coordinates.join(", ")
    : "77.5946, 12.9716" // fallback static value
}
              onChange={(e) => {
                const coords = e.target.value
                  .split(",")
                  .map((c) => parseFloat(c.trim()));
                handleClinicChange(index, "location", {
                  type: "Point",
                  coordinates: coords,
                });
              }}
        ...
        <div className="space-y-4">
          ...
          <textarea
            ...
            onChange={(e) =>
              handleClinicChange(index, "clinicAddress", e.target.value)
            }
            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500"
            rows={3}
          />
